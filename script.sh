...
echo "Разработчик программы: Мухачева А.А. Гр. 748"
echo "программа-обработчик файлов"
echo "программа предназначена для создания, удаления, перемещения файлов"
while :
do
